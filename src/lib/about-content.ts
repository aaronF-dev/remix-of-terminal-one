// Single source of truth for the README + in-app About dialog.
// Edit here; the About modal and README.md both consume this string.

export const ABOUT_MARKDOWN = `# Terminal One — Financial Intelligence OS
...
repaired by an extractor before validation so the UI never crashes on a bad
model output.
